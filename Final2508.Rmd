...
results_rf <- data.frame(
  Actual_Label = combined_data$label,
  Predicted_Label = predict(tuned_rf_model, newdata = combined_data)
)
...
osn_predictions_rf <- results_rf[results_rf$Predicted_Label == "OSN", ]

# List of rownames where predicted label is "OSN"
osn_rownames_rf <- rownames(combined_data)[results_rf$Predicted_Label == "OSN"]
length(osn_rownames_rf)
head(osn_rownames_rf, 100)
```
...
length(osn_rownames_xgb)
head(osn_rownames_xgb, 100)
