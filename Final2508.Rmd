...
Using `OSN_target_genes` as a comparison with the model, suggests that SVN overclassifies target genes. This may suggest a need not for downsampling or it may suggest that there are other methods of dealing with class imabalance. 
...
# Debugging output to understand the structure
print(str(xgb_predictions))

# Adjust the following line based on the structure of xgb_predictions
predicted_classes_xgb <- ifelse(xgb_predictions > 0.5, "OSN", "Other")

# Create a logical vector for the specific label "OSN"
is_osn_xgb <- predicted_classes_xgb == "OSN"
print(length(is_osn_xgb))
