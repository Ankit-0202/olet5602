...
Here we improve on our model by performing cross-validation while training the Random Forest, and finetuning our hyperaparamaters as to not over fit the model.
