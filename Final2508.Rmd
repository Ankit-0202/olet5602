...
Here we train our second model on the down sampled data. The dataset performed best with better with a larger number of trees, and so we have used 1000 for our hyperparamater. 
...
Here we improve on our model by performing cross-validation while training the Random Forest, and finetuning our hyperaparamters as to not over fit the model.
...
## Results
Lets analyse the results of the overall study.
